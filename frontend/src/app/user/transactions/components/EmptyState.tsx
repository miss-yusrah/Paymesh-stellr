...
//   return (
//     <div className="flex flex-col items-center justify-center py-20 px-6 bg-[#12131A] rounded-2xl border border-white/10">
...
//       <p className="text-[#A0A5BA] text-center max-w-md">
//         When you start making transactions, they will appear here with all the details including amounts, recipients, and timestamps.
//       </p>
//     </div>
//   );
// }
